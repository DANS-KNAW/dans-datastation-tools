...
from datastation.common.batch_processing import get_pids, DatasetBatchProcessor, DatasetBatchProcessorWithReport
...
def main():
    ...
    DatasetBatchProcessor(wait=args.wait, fail_on_first_error=args.fail_fast).process_pids(
